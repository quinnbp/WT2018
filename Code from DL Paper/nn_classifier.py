...
data = f.get("~/Deep_Learning_Paper/")

data_as_array = np.array(data)

np.savez("Pleasebethemodel.npz", data_as_array)


word2vec_model1 = np.load("Pleasebethemodel.npz")
#print (word2vec_model1.files)


word2vec_model1 = word2vec_model1['arr_0'].reshape((word2vec_model1.shape[1], word2vec_model1.shape[2]))
